...
import 'package:flutterfirebase/models/employee.dart';
import 'package:flutterfirebase/page/addpage.dart';
import 'package:flutterfirebase/page/editpage.dart';
...
class _ListPage extends State<Listpage> {
  final Stream<QuerySnapshot> CollectionReference = FirebasedCrud.readEmployee();
    @override 
                        ...
                        ButtonBar(
                          ...
                          children: <Widget>[
                            ...
                            TextButton (
                              ...
                              onPressed: ()async {
                                var response = 
                                await FirebasedCrud.deleteEmployee(docId: e.id);
